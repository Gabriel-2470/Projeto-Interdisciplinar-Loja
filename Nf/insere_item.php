    ...
    <div class="container">
        <div class="row">
                    <div class="wrap-login100">
                        ...
                        <form class="login100-form validate-form" action="insere_item_nf.php" method="POST">
                            
                            <div class="wrap-input100 validate-input m-b-26" data-validate="Email Necessario">
                                <span class="label-input100">ID do produto</span>
                                <input class="input100" type="text" name="id_prod" value="<?php echo $id_prod; ?>" readonly="readonly">
                                <span class="focus-input100"></span>
                            </div>
    
                            <div class="wrap-input100 validate-input m-b-18" data-validate = "Senha Necessaria">
                                <span class="label-input100">Produto</span>
                                <input class="input100" type="text" name="nome_prod" value="<?php echo $nome; ?>" readonly="readonly">
                                <span class="focus-input100"></span>
                            </div>

                             <div class="wrap-input100 validate-input m-b-18" data-validate = "Senha Necessaria">
                                <span class="label-input100">Preço unitario</span>
                                <input class="input100" type="text" name="valor_unit" value="<?php echo $preco; ?>" readonly="readonly">
                                <span class="focus-input100"></span>
                            </div>

                             <div class="wrap-input100 validate-input m-b-18" data-validate = "Senha Necessaria">
                                <span class="label-input100">Quantidade</span>
                                <input class="input100" type="text" name="qtde" value="<?php echo $qtde_prod; ?>" readonly="readonly">
                                <span class="focus-input100"></span>
                            </div>

                             <div class="wrap-input100 validate-input m-b-18" data-validate = "Senha Necessaria">
                                <span class="label-input100">Subtotal</span>
                                <input class="input100" type="text" name="subtotal" value="<?php echo $subtotal; ?>" readonly="readonly">
                                <span class="focus-input100"></span>
                            </div>
