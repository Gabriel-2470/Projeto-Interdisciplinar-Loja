    ...
    <div class="container">
        <div class="row">
                    <div class="wrap-login100">
                        ...
                        <form class="login100-form validate-form" action="cadastra_produto.php" method="POST">
                            
                            <div class="wrap-input100 validate-input m-b-26" data-validate="Preencha este campo">
                                <span class="label-input100">Nome</span>
                                <input class="input100" type="text" name="nome" placeholder="Insira o nome do produto">
                            ...
                            <div class="wrap-input100 validate-input m-b-18" data-validate = "Preencha este campo">
                                ...
                                <input class="input100" type="decimal" name="preco" placeholder="Insira o Preço do produto">
                                <span class="focus-input100"></span>
                            </div>
