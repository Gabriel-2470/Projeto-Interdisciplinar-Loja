    ...
    <div class="container">
        <div class="row">
                    <div class="wrap-login100">
                        ...
                        <form class="login100-form validate-form" action="cadastra_usuario.php" method="POST">
                            
                            <div class="wrap-input100 validate-input m-b-26" data-validate="Preencha este campo">
                                <span class="label-input100">Nome</span>
                                <input class="input100" type="text" name="nome" placeholder="Insira o nome de usuario">
                                <span class="focus-input100"></span>
                            </div>
    
                            <div class="wrap-input100 validate-input m-b-18" data-validate = "Preencha este campo">
                                <span class="label-input100">Email</span>
                                <input class="input100" type="email" name="email" placeholder="Insira o email">
                                <span class="focus-input100"></span>
                            </div>

                            <div class="wrap-input100 validate-input m-b-18" data-validate = "Preencha este campo">
                                <span class="label-input100">Senha</span>
                                <input class="input100" type="text" name="senha" placeholder="insira uma senha">
                                <span class="focus-input100"></span>
                            </div>
