    ...
    <div class="container">
        <div class="row">
                    <div class="wrap-login100">
                        ...
                        <form class="login100-form validate-form" action="insere_item.php?nf='<?php echo $ultimo; ?>'" method="POST">
                            
                            <div class="wrap-input100 validate-input m-b-26" data-validate="Email Necessario">
                                <span class="label-input100">Nº NF</span>
                                <input class="input100" type="text" name="nf" value="<?php echo $ultimo;?>">
                                <span class="focus-input100"></span>
                            </div>
    
                            <div class="wrap-input100 validate-input m-b-18" data-validate = "Senha Necessaria">
                                <span class="label-input100">Produto</span>
                                <select class="seleciona" name="produto_opcao" id="produto_opcao">
                                <?php
                             ...
                             <div class="wrap-input100 validate-input m-b-18" data-validate = "Senha Necessaria">
                                ...
                                <input class="input100" type="text" name="qtde">
                                <span class="focus-input100"></span>
                            </div>
